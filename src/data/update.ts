...
export const filterUpdateEntities = (
  ...
  (
    ...
    if (a.attributes.title === "AutoHome Core") {
      return -3;
    }
    if (b.attributes.title === "AutoHome Core") {
      return 3;
    }
    if (a.attributes.title === "AutoHome Operating System") {
      return -2;
    }
    if (b.attributes.title === "AutoHome Operating System") {
      return 2;
    }
    if (a.attributes.title === "AutoHome Supervisor") {
      return -1;
    }
    if (b.attributes.title === "AutoHome Supervisor") {
      return 1;
    }
