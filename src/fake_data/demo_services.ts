...
export const demoServices: HassServices = {
  homeassistant: {
    ...
    stop: { description: "Stop the AutoHome service.", fields: {} },
    restart: { description: "Restart the AutoHome service.", fields: {} },
    check_config: {
      description:
        "Check the AutoHome configuration files for errors. Errors will be displayed in the AutoHome log.",
      fields: {},
    },
    update_entity: {
