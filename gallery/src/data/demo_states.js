export default {
  ...
  "weather.demo_weather_south": {
    ...
    attributes: {
      ...
      pressure: 1099,
      wind_speed: 0.5,
      attribution: "Powered by AutoHome",
      forecast: [
        {
  ...
  "configurator.philips_hue": {
    ...
    attributes: {
      ...
      entity_picture: null,
      description:
        "Press the button on the bridge to register Philips Hue with AutoHome.\n\n![Description image](/static/images/config_philips_hue.jpg)",
